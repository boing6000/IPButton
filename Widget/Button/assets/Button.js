...
var IpWidget_Button = function () {
    ...
    var openPopup = function () {
        ...
        $('#ipWidgetButtonPopup').remove(); //remove any existing popup. This could happen if other widget is in management state right now.

        //get popup HTML using AJAX. See AdminController.php widgetPopupHtml function
        var data = {
            aa: 'Button.widgetPopupHtml',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var $popup = $('#ipWidgetButtonPopup .ipsModal');
                $popup.modal();
